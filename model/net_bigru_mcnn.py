...
class Net(torch.nn.Module):
    ...
    def __init__(self, args, params):
        ...
        self.bigru_layer = nn.GRU(input_size=128, hidden_size=self.bilstm_gru_hidden_dim, num_layers=4, batch_first=True, bidirectional=True)
        self.bigru_dropout = nn.Dropout(0.3)
    ...
    def forward(self, words, pos1, pos2):
        ...
        gru_in = self.origin_dense(features)
        gru_out,_ = self.bigru_layer(gru_in)
        x = self.bigru_dropout(gru_out)
