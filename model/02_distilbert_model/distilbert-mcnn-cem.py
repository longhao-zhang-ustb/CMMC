...
class Net(torch.nn.Module):
    ...
    def __init__(self, args, params, class_num):
        ...
        self.mamba_layer = CEMambaEncoder(feature_dim=params.kernel_num * len(params.kernel_sizes))   
        self.mamba_norm = nn.LayerNorm(params.kernel_num * len(params.kernel_sizes))
        ######################################################
    ...
    def forward(self, words, pos1, pos2, attention_mask=None):
        if self.bert:
            with torch.no_grad():
