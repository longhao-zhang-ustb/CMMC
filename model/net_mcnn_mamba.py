...
class Net(torch.nn.Module):
    ...
    def __init__(self, args, params):
        ...
        self.convs_pool = nn.AdaptiveAvgPool1d(1024)
        self.mamba_args = ModelArgs(d_model=1024, n_layer=8, d_state=16)
        self.bimamba_layer = nn.Sequential(
            BiMambaEncoder(self.mamba_args)
        )
        self.mamba_norm = nn.LayerNorm(1024)
